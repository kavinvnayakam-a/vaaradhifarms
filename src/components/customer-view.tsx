    ...
    <div className="min-h-screen bg-background overflow-x-hidden relative">
      ...
      <main className="max-w-5xl mx-auto px-4 md:px-6 py-12 md:py-24 relative z-20">
        <header className="mb-24 text-center">
          <h1 className="text-6xl md:text-[10rem] font-black text-primary tracking-tighter uppercase italic leading-none animate-in fade-in slide-in-from-bottom-8 duration-1000">
            Vaaradhi <span className="text-accent">Farms</span>
          </h1>
          <p className="text-[10px] font-black uppercase tracking-[0.6em] text-primary/20 mt-4">Purely Authentic Flavors</p>
        </header>
          ...
          {categorizedMenu.map(({ category, items }) => (
            <section key={category} id={category} className="scroll-mt-52">
              <div className="flex flex-col gap-4 mb-16">
                <span className="text-accent font-black text-[10px] uppercase tracking-[0.4em]">Experience</span>
                <div className="flex items-center gap-8">
                    <h3 className="text-3xl md:text-5xl font-black italic uppercase tracking-tighter text-primary">
                    {category}
                    </h3>
      ...
      <footer className="bg-primary py-32 px-6">
        <div className="max-w-5xl mx-auto flex flex-col items-center gap-12">
          <div className="bg-white px-8 py-4 rounded-2xl shadow-2xl border-2 border-accent/30">
      ...
      <button
        ...
        className={cn(
          "fixed bottom-28 right-8 z-50 p-5 bg-accent text-white rounded-full shadow-2xl transition-all duration-500 hover:scale-110",
